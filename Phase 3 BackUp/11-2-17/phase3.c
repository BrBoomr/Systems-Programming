...
void pToIntermFile() {
	...
	fprintf(I_File, "----------------------------------------------------------------------------------------------------------\n");
	fprintf(I_File, "Line\t |\t OpCode\t |\t Operand\t |\t\t Location\t |\t Error\t |\t\t\t Source Line\t\t|\n");
	for (int x = 0; x < T_SIZE; x++) {
		...
		fprintf(I_File, "%d\t\t %#x\t\t %-8s\t\t\t %x\t\t\t %d\t\t %s\n", I_Table[x]->Line, I_Table[x]->OpCode, I_Table[x]->Operand, I_Table[x]->Location, I_Table[x]->Error, I_Table[x]->Source);
	}
	fprintf(I_File, "\n Codes:\n");
	fprintf(I_File, "----------------------------\n");
